...
class CandidatesApiTests : ChronicleServerTests() {
    ...
    fun testGetCandidates() {
        val c1 = Candidate(firstName = "iron", lastName = "man", dob = LocalDate.parse("2008-05-02"))
        val c1Id = clientUser1.candidatesApi.registerCandidate(c1)
        c1.candidateId = c1Id
        val c2 = Candidate(firstName = "black", lastName = "panther", dob = LocalDate.parse("2018-02-16"))
