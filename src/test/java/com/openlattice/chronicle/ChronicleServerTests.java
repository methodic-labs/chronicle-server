...
import static com.openlattice.chronicle.ChronicleTestUtils.*;
...
public class ChronicleServerTests {
    ...
    public static void initialize() throws ExecutionException {
        ...
        Retrofit chronicleApiAdapter = createRetrofitAdapter(client);
        chronicleApi = chronicleApiAdapter.create( ChronicleApi.class );

        Retrofit chronicleStudyApiAdapter = createRetrofitAdapter( client );
        chronicleStudyApi = chronicleStudyApiAdapter.create( ChronicleStudyApi.class );
    ...
    private static Interceptor handleChronicleStudyApiRequest() {
    ...
    private static Interceptor handleChronicleApiRequest() {
    ...
    private List<SetMultimap<UUID, Object>> createMockData(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            dataItem.put( fullNamePTID, RandomStringUtils.randomAlphabetic( 10 ) );
