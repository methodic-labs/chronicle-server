...
public class EdmConstants {
    ...
    public static final FullQualifiedName DATASOURCE_FQN          = new FullQualifiedName( "ol.datasource" );
    ...
    public static final FullQualifiedName NEW_APP_FQN             = new FullQualifiedName( "ol.newapp" );
