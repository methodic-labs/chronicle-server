...
public class ChronicleServiceImpl implements ChronicleService {
    ...
    public ChronicleServiceImpl(
        ...
        startDateTimePTID = edmApi
                .getPropertyTypeId( START_DATE_TIME_FQN.getNamespace(), START_DATE_TIME_FQN.getName() );
    ...
    private void deleteStudyData(
        ...
        try {
            ...
            Set<UUID> srcNeighborSetIds = ImmutableSet.of( deviceESID, dataESID, preProcessedESID, answersESID );
