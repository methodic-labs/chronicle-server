...
public class ChronicleServiceImpl implements ChronicleService {
    ...
    private void createEntitiesAndAssociations(
        ...
        for ( int i = 0; i < data.size(); i++ ) {
            ...
            appDataAssociations
                    .putAll( getAppDataAssociations( deviceEKID, participantEKID, appDataESID, devicesESID, recordedByESID, participantESID, timeStamp, i ) );
            ...
            if ( !userAppsFullNameValues.getOrDefault( appPackageName, ImmutableSet.of() ).contains( organizationId ) ) {
