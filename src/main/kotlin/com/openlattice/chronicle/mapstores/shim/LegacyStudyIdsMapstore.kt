package com.openlattice.chronicle.mapstores.shim
...
@Component
class LegacyStudyIdsMapstore(val hds: HikariDataSource) : TestableSelfRegisteringMapStore<UUID, Study> {
    ...
    override fun getTable(): String = LEGACY_STUDY_IDS.name
}