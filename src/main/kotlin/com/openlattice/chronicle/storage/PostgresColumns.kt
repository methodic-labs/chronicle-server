...
class PostgresColumns {
    companion object {
        ...
        @JvmField val IOS_DATES_COUNT = PostgresColumnDefinition("ios_dates_count", PostgresDatatype.INTEGER).withDefault(0)
        ...
        @JvmField val TUD_DATES_COUNT = PostgresColumnDefinition("tud_dates_count", PostgresDatatype.INTEGER).withDefault(0)
