...
class PostgresColumns {
    companion object {
        ...
        @JvmField val ANDROID_UNIQUE_DATES = PostgresColumnDefinition("android_unique_dates", PostgresDatatype.DATE_ARRAY)
        ...
        @JvmField val IOS_UNIQUE_DATES = PostgresColumnDefinition("ios_unique_dates", PostgresDatatype.DATE_ARRAY)
        ...
        @JvmField val TUD_UNIQUE_DATES = PostgresColumnDefinition("tud_dates_count", PostgresDatatype.DATE_ARRAY)
