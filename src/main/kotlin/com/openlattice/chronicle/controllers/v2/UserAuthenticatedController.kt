...
class UserAuthenticatedController : UserAuthenticatedApi {
    ...
    override fun getAllPreprocessedParticipantData(
        ...
        return dataDownloadManager
                .getParticipantData(
                        organizationId, studyId, participantEntityKeyId, ParticipantDataType.PREPROCESSED, token
                )
    }
    ...
    override fun getAllParticipantData(
        ...
        return dataDownloadManager!!.getParticipantData(
                organizationId, studyId, participantEntityKeyId, ParticipantDataType.RAW_DATA, token
        )
    }
    ...
    override fun getAllParticipantAppsUsageData(
            organizationId: UUID, studyId: UUID, participantEntityKeyId: UUID, fileType: FileType
    ): Iterable<Map<String, Set<Any>>> {
        val token = ChronicleServerUtil.getTokenFromContext()
        return dataDownloadManager
                .getParticipantData(
                        organizationId, studyId, participantEntityKeyId, ParticipantDataType.USAGE_DATA, token
                )
    }
